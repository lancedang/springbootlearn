...
public
class MyImportBeanDefinitionRegister
    ...
    public void registerBeanDefinitions(
        ...
        if (value.equalsIgnoreCase("com.lance.test")) {
            BeanDefinition beanDefinition1 =
                    BeanDefinitionBuilder.genericBeanDefinition(SelfModel1.class).getBeanDefinition();
            registry.registerBeanDefinition("selfModel1", beanDefinition1);

            BeanDefinition beanDefinition2 =
                    BeanDefinitionBuilder.genericBeanDefinition(SelfModel2.class).getBeanDefinition();
